...
import com.extrawest.ocpi.cpo.client.model.ResponseFormatListCDRDto;
...
public class CpoCdrApi {
     ...
     * @return ResponseFormatListCDRDto
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseFormatListCDRDto getCdr(OffsetDateTime dateFrom, OffsetDateTime dateTo, Integer offset, Integer limit) throws RestClientException {
     ...
     * @param offset   (required)
     * @param limit    (required)
     * @return ResponseEntity&lt;ResponseFormatListCDRDto&gt;
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<ResponseFormatListCDRDto> getCdrWithHttpInfo(OffsetDateTime dateFrom, OffsetDateTime dateTo, Integer offset, Integer limit) throws RestClientException {
        ...
        ParameterizedTypeReference<ResponseFormatListCDRDto> localReturnType = new ParameterizedTypeReference<ResponseFormatListCDRDto>() {
        };
