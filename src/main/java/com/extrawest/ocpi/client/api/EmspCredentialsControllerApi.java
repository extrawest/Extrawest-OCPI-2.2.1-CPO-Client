...
import com.extrawest.ocpi.client.model.CredentialsDTO;
...
public class EmspCredentialsControllerApi {
    ...
    public ResponseEntity<Void> deleteCredentialsWithHttpInfo(CredentialsDTO credentialsDTO) throws RestClientException {
        ...
        return apiClient.invokeAPI("/emsp/api/2.2.1/credentials", HttpMethod.DELETE, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
    /**
     * 
     * 
    ...
    public ResponseEntity<CredentialsDTO> getCredentialsWithHttpInfo() throws RestClientException {
        ...
        return apiClient.invokeAPI("/emsp/api/2.2.1/credentials", HttpMethod.GET, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
    /**
     * 
     * 
    ...
    public ResponseEntity<Void> postCredentialsWithHttpInfo(CredentialsDTO credentialsDTO) throws RestClientException {
        ...
        ParameterizedTypeReference<Void> localReturnType = new ParameterizedTypeReference<Void>() {};
        return apiClient.invokeAPI("/emsp/api/2.2.1/credentials", HttpMethod.POST, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
    /**
     * 
     * 
    ...
    public ResponseEntity<Void> putCredentialsWithHttpInfo(CredentialsDTO credentialsDTO) throws RestClientException {
        ...
        ParameterizedTypeReference<Void> localReturnType = new ParameterizedTypeReference<Void>() {};
        return apiClient.invokeAPI("/emsp/api/2.2.1/credentials", HttpMethod.PUT, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
}
